...
WSGI_APPLICATION = 'manoloacademia.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'manoloacademia$ads',
        'USER': 'manoloacademia',
        'PASSWORD': 'FutBol#3314',
        'HOST': 'manoloacademia.mysql.pythonanywhere-services.com',
         'OPTIONS': {
