...
class AdCreateView(LoginRequiredMixin, View): #From PicCreateView to AdCreateView
...
class AdUpdateView(LoginRequiredMixin, View): #From PicUpdateView to AdUpdateView
    template_name = 'ads/ad_form.html'
    success_url = reverse_lazy('pics:all')
